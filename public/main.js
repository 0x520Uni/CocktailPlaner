...
var $author$project$Api$categoriesDecoder = A2(
	$elm$json$Json$Decode$field,
	'drinks',
	$elm$json$Json$Decode$list(
		A2($elm$json$Json$Decode$field, 'strCategory', $elm$json$Json$Decode$string)));
			...
			if (_v0.a === 2) {
				switch (_v0.b.$) {
					case 0:
						var _v1 = _v0.a;
						var _v2 = _v0.b;
						return $author$project$Api$fetchCategories;
					case 3:
						var _v3 = _v0.a;
						var _v4 = _v0.b;
						return $author$project$Api$fetchCategories;
...
var $author$project$Types$GlossarRoute = 2;
var $author$project$Types$ShoppingRoute = 1;
...
var $author$project$Route$parser = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			1,
			$elm$url$Url$Parser$s('shopping')),
			A2(
			$elm$url$Url$Parser$map,
			2,
			$elm$url$Url$Parser$s('glossar'))
		]));
...
var $author$project$Types$CategoriesFailed = {$: 3};
var $author$project$Types$CategoriesLoaded = function (a) {
	return {$: 2, a: a};
};
var $author$project$Types$CategoriesLoading = {$: 1};
var $author$project$Types$CreateEventDialog = 3;
var $author$project$Types$Failed = {$: 2};
var $author$project$Types$GotEventSearchResults = function (a) {
	return {$: 26, a: a};
};
var $author$project$Types$GotGlossarSearchResults = function (a) {
	return {$: 23, a: a};
};
...
var $author$project$Types$GotFullCocktail = function (a) {
	return {$: 11, a: a};
};
...
var $author$project$Types$LiquidMl = function (a) {
	return {$: 0, a: a};
};
var $author$project$Types$PieceCount = function (a) {
	return {$: 1, a: a};
};
var $author$project$Types$UnknownAmount = {$: 2};
...
var $author$project$Api$parseFractionToken = function (s) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.b.b)) {
		...
		return A3(
			...
			$elm$core$String$toFloat(num),
			$elm$core$String$toFloat(den));
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
var $author$project$Api$parseNumericToken = function (rawToken) {
	var token = function () {
		var _v2 = A2($elm$core$String$split, '-', rawToken);
		if (_v2.b && _v2.b.b) {
			var lower = _v2.a;
			var _v3 = _v2.b;
			return lower;
	...
	while (true) {
		if (_v0.b) {
			if (!_v0.b.b) {
				var num = _v0.a;
				return $elm$core$String$toFloat(num);
			} else {
				if (!_v0.b.b.b) {
					var num = _v0.a;
					var _v1 = _v0.b;
...
var $author$project$Api$extractLeadingNumber = function (raw) {
	...
	if (!_v0.b) {
		...
		var first = _v0.a;
		var rest = _v0.b;
		var _v1 = $author$project$Api$parseNumericToken(first);
		if (!_v1.$) {
			var n = _v1.a;
			if (rest.b) {
				var next = rest.a;
				var _v3 = $author$project$Api$parseFractionToken(next);
				if (!_v3.$) {
					var f = _v3.a;
					return $elm$core$Maybe$Just(n + f);
				} else {
...
var $author$project$Api$parseMeasureToAmount = function (raw) {
	var number = $author$project$Api$extractLeadingNumber(raw);
	var lower = $elm$core$String$toLower(
		$elm$core$String$trim(raw));
	if (A2($elm$core$String$contains, 'oz', lower)) {
		return A2(
			$elm$core$Maybe$withDefault,
			$author$project$Types$UnknownAmount,
			A2(
				$elm$core$Maybe$map,
				function (n) {
					return $author$project$Types$LiquidMl(n * 29.57);
				},
				number));
	} else {
		if (A2($elm$core$String$contains, 'tblsp', lower) || A2($elm$core$String$contains, 'tbsp', lower)) {
			return A2(
				$elm$core$Maybe$withDefault,
				$author$project$Types$UnknownAmount,
				A2(
					$elm$core$Maybe$map,
					function (n) {
						return $author$project$Types$LiquidMl(n * 15);
					},
					number));
		} else {
			if (A2($elm$core$String$contains, 'tsp', lower)) {
				return A2(
					$elm$core$Maybe$withDefault,
					$author$project$Types$UnknownAmount,
					A2(
						$elm$core$Maybe$map,
						function (n) {
							return $author$project$Types$LiquidMl(n * 5);
						},
						number));
			} else {
				if (A2($elm$core$String$contains, 'cl', lower)) {
					return A2(
						$elm$core$Maybe$withDefault,
						$author$project$Types$UnknownAmount,
						A2(
							$elm$core$Maybe$map,
							function (n) {
								return $author$project$Types$LiquidMl(n * 10);
							},
							number));
				} else {
					if (A2($elm$core$String$contains, 'ml', lower)) {
						return A2(
							$elm$core$Maybe$withDefault,
							$author$project$Types$UnknownAmount,
							A2($elm$core$Maybe$map, $author$project$Types$LiquidMl, number));
					} else {
						if (A2($elm$core$String$contains, 'cup', lower)) {
							return A2(
								$elm$core$Maybe$withDefault,
								$author$project$Types$UnknownAmount,
								A2(
									$elm$core$Maybe$map,
									function (n) {
										return $author$project$Types$LiquidMl(n * 240);
									},
									number));
						} else {
							if (A2($elm$core$String$contains, 'shot', lower)) {
								return A2(
									$elm$core$Maybe$withDefault,
									$author$project$Types$UnknownAmount,
									A2(
										$elm$core$Maybe$map,
										function (n) {
											return $author$project$Types$LiquidMl(n * 44);
										},
										number));
							} else {
								if (A2($elm$core$String$contains, 'dash', lower)) {
									return A2(
										$elm$core$Maybe$withDefault,
										$author$project$Types$LiquidMl(0.6),
										A2(
											$elm$core$Maybe$map,
											function (n) {
												return $author$project$Types$LiquidMl(n * 0.6);
											},
											number));
								} else {
									if (A2($elm$core$String$contains, 'drop', lower)) {
										return A2(
											$elm$core$Maybe$withDefault,
											$author$project$Types$UnknownAmount,
											A2(
												$elm$core$Maybe$map,
												function (n) {
													return $author$project$Types$LiquidMl(n * 0.05);
												},
												number));
									} else {
										if (A2(
											...
											'l',
											$elm$core$String$words(lower)) || A2(
											$elm$core$List$member,
											'liter',
											$elm$core$String$words(lower))) {
											return A2(
												$elm$core$Maybe$withDefault,
												$author$project$Types$UnknownAmount,
												A2(
													$elm$core$Maybe$map,
													function (n) {
														return $author$project$Types$LiquidMl(n * 1000);
													},
													number));
										} else {
											if (!number.$) {
												var n = number.a;
												return $author$project$Types$PieceCount(n);
											} else {
												return $author$project$Types$UnknownAmount;
											}
										}
									}
								}
...
var $author$project$Api$ingredientsDecoder = A2(
	$elm$json$Json$Decode$andThen,
	function (rawValue) {
		var readSlot = function (n) {
			var nStr = $elm$core$String$fromInt(n);
			var nameResult = A2(
				$elm$json$Json$Decode$decodeValue,
				A2($elm$json$Json$Decode$field, 'strIngredient' + nStr, $elm$json$Json$Decode$string),
				rawValue);
			var measureResult = A2(
				$elm$json$Json$Decode$decodeValue,
				A2($elm$json$Json$Decode$field, 'strMeasure' + nStr, $elm$json$Json$Decode$string),
				rawValue);
			if (!nameResult.$) {
				...
				if ($elm$core$String$isEmpty(
					...
					var measure = function () {
						if (!measureResult.$) {
							var m = measureResult.a;
							return $elm$core$String$trim(m);
						} else {
							return '';
						}
					}();
...
var $author$project$Api$drinkObjectDecoder = A6(
	$elm$json$Json$Decode$map5,
	$author$project$Types$FullCocktail,
	A2($elm$json$Json$Decode$field, 'idDrink', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'strDrink', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'strDrinkThumb', $elm$json$Json$Decode$string),
	$author$project$Api$ingredientsDecoder,
	A2($elm$json$Json$Decode$field, 'strInstructions', $elm$json$Json$Decode$string));
var $elm$json$Json$Decode$index = _Json_decodeIndex;
var $author$project$Api$fullCocktailDecoder = A2(
	$elm$json$Json$Decode$field,
	'drinks',
	A2($elm$json$Json$Decode$index, 0, $author$project$Api$drinkObjectDecoder));
...
var $author$project$Types$GotCocktailSummaries = F2(
	function (a, b) {
		return {$: 9, a: a, b: b};
	});
...
var $author$project$Api$cocktailSummariesDecoder = A2(
	...
	$elm$json$Json$Decode$list(
		A4(
			...
			$author$project$Types$CocktailSummary,
			A2($elm$json$Json$Decode$field, 'idDrink', $elm$json$Json$Decode$string),
			A2($elm$json$Json$Decode$field, 'strDrink', $elm$json$Json$Decode$string),
			A2($elm$json$Json$Decode$field, 'strDrinkThumb', $elm$json$Json$Decode$string))));
	...
	return $elm$http$Http$get(
		{
			...
			U: 'https://www.thecocktaildb.com/api/json/v1/1/filter.php?c=' + $elm$url$Url$percentEncode(category)
		});
};
...
var $author$project$Codec$pairDecoder = A3(
	$elm$json$Json$Decode$map2,
	$elm$core$Tuple$pair,
	A2($elm$json$Json$Decode$index, 0, $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$index, 1, $elm$json$Json$Decode$float));
var $author$project$Codec$dictDecoder = A2(
...
var $author$project$Codec$eventCocktailDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Types$EventCocktail,
	A2($elm$json$Json$Decode$field, 'cocktailId', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'portions', $elm$json$Json$Decode$int));
var $elm$json$Json$Decode$map4 = _Json_map4;
var $author$project$Codec$eventDecoder = A5(
	$elm$json$Json$Decode$map4,
	$author$project$Types$Event,
	A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'guestCount', $elm$json$Json$Decode$int),
	A2(
		$elm$json$Json$Decode$field,
		'cocktails',
		$elm$json$Json$Decode$list($author$project$Codec$eventCocktailDecoder)));
var $author$project$Codec$stateDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Codec$SavedState,
	A2(
		$elm$json$Json$Decode$field,
		'events',
		$elm$json$Json$Decode$list($author$project$Codec$eventDecoder)),
	A2($elm$json$Json$Decode$field, 'nextEventId', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'packageSizes', $author$project$Codec$dictDecoder));
var $author$project$Codec$parseState = function (json) {
	var _v0 = A2($elm$json$Json$Decode$decodeString, $author$project$Codec$stateDecoder, json);
	if (!_v0.$) {
		var state = _v0.a;
		...
		var err = _v0.a;
		return $elm$core$Result$Err(
			'Ungültiges Format: ' + $elm$json$Json$Decode$errorToString(err));
	}
};
var $elm$browser$Browser$Navigation$pushUrl = _Browser_pushUrl;
var $elm$json$Json$Decode$null = _Json_decodeNull;
var $elm$json$Json$Decode$oneOf = _Json_oneOf;
var $author$project$Api$searchResultsDecoder = A2(
	$elm$json$Json$Decode$field,
	'drinks',
	$elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[
				$elm$json$Json$Decode$list($author$project$Api$drinkObjectDecoder),
				$elm$json$Json$Decode$null(_List_Nil)
			])));
var $author$project$Api$searchCocktailsByName = F2(
		...
		switch (msg.$) {
			...
			case 10:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							_: $elm$core$Maybe$Just(id)
						}),
					fetchCmd);
			case 11:
				if (!msg.a.$) {
					var cocktail = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
					...
					if (nameEmpty) {
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									E: $elm$core$Maybe$Just('Bitte einen Namen eingeben.')
								}),
							$elm$core$Platform$Cmd$none);
					} else {
						if (nameTaken) {
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										E: $elm$core$Maybe$Just('Ein Event mit diesem Namen existiert bereits.')
									}),
								$elm$core$Platform$Cmd$none);
						} else {
							var newId = $elm$core$String$fromInt(model.ao);
							var guestCount = A2(
								$elm$core$Maybe$withDefault,
								10,
			...
			case 25:
				return $elm$core$String$isEmpty(
					$elm$core$String$trim(model.F)) ? _Utils_Tuple2(model, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					_Utils_update(
						model,
						{G: _List_Nil}),
					A2($author$project$Api$searchCocktailsByName, model.F, $author$project$Types$GotEventSearchResults));
			case 26:
				if (!msg.a.$) {
					var cocktails = msg.a.a;
					var newCache = A3(
						$elm$core$List$foldl,
						F2(
							function (c, acc) {
			...
			case 22:
				var query = msg.a;
				return ($elm$core$String$length(query) >= 2) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{Z: query}),
			...
			case 30:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							aq: A3($elm$core$Dict$insert, ingredientName, size, model.aq)
						}),
					$elm$core$Platform$Cmd$none);
			case 31:
				return _Utils_Tuple2(
...
var $author$project$Types$CloseDialog = {$: 4};
var $author$project$Types$ImportTextChanged = function (a) {
	return {$: 5, a: a};
};
var $author$project$Types$LoadDialog = 2;
var $author$project$Types$LoadProject = {$: 6};
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onClick($author$project$Types$CloseDialog)
					]),
				_List_Nil),
				A2(
				$elm$html$Html$div,
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Projekt laden')
									])),
								A2(
						...
						_List_fromArray(
							[
								$elm$core$List$isEmpty(model.ai) ? $elm$html$Html$text('') : A2(
								$elm$html$Html$article,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('message is-warning mb-3')
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$text('Es ist bereits ein Projekt offen. Laden überschreibt alle aktuellen Daten.')
											]))
									])),
								A2(
								$elm$html$Html$p,
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Füge den gespeicherten Text ein und klicke auf \"Laden\".')
									])),
								A2(
								$elm$html$Html$textarea,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('textarea is-family-monospace'),
										$elm$html$Html$Attributes$rows(12),
										$elm$html$Html$Attributes$placeholder('{ \"events\": [ ... ] }'),
										$elm$html$Html$Attributes$value(model.H),
										$elm$html$Html$Events$onInput($author$project$Types$ImportTextChanged)
									]),
								_List_Nil),
								function () {
								var _v0 = model.K;
								if (!_v0.$) {
									...
									return A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('has-text-danger mt-2')
											]),
										_List_fromArray(
											[
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Events$onClick($author$project$Types$LoadProject)
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('button ml-2'),
										$elm$html$Html$Events$onClick($author$project$Types$CloseDialog)
									]),
								_List_fromArray(
									[
...
var $author$project$Types$SelectCategory = function (a) {
	return {$: 8, a: a};
};
var $elm$html$Html$li = _VirtualDom_node('li');
var $elm$virtual_dom$VirtualDom$style = _VirtualDom_style;
var $elm$html$Html$Attributes$style = $elm$virtual_dom$VirtualDom$style;
var $author$project$View$Glossar$categoryItem = F2(
	function (selectedCategory, name) {
		var isActive = _Utils_eq(
			selectedCategory,
			$elm$core$Maybe$Just(name));
		var activeStyle = isActive ? _List_fromArray(
			[
				$elm$html$Html$Attributes$class('has-background-primary-light has-text-primary py-1 px-2'),
			...
			[
				...
				$author$project$Types$SelectCategory(name))
			]);
		return A2(
			$elm$html$Html$li,
			activeStyle,
	...
	switch (_v0.$) {
		case 0:
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Wird geladen...')
					]));
		case 1:
			return A2(
				$elm$html$Html$p,
		...
		case 3:
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Fehler beim Laden.')
					]));
		default:
			var names = _v0.a;
			return A2(
...
var $author$project$View$Glossar$isSearchActive = function (model) {
	return $elm$core$String$length(model.Z) >= 2;
};
var $author$project$View$Glossar$columnCategories = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				A2($elm$html$Html$Attributes$style, 'width', '200px'),
				A2($elm$html$Html$Attributes$style, 'border-right', '1px solid #dbdbdb'),
				A2($elm$html$Html$Attributes$style, 'overflow-y', 'auto'),
				$elm$html$Html$Attributes$class('p-3 glossar-col-categories')
			]),
		_List_fromArray(
			[
				$author$project$View$Glossar$isSearchActive(model) ? A2(
				$elm$html$Html$p,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('has-text-grey is-size-7 has-text-weight-semibold')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Suchergebnisse für \"' + (model.Z + '\"'))
					])) : $author$project$View$Glossar$categoryPanel(model)
			]));
};
var $author$project$Types$SelectCocktail = function (a) {
	return {$: 10, a: a};
};
var $author$project$View$Glossar$cocktailItem = F2(
...
var $author$project$View$Glossar$cocktailListPanel = function (model) {
	...
	if (_v0.$ === 1) {
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('← Kategorie auswählen')
				]));
	} else {
		var category = _v0.a;
...
var $author$project$View$Glossar$searchResultsPanel = function (model) {
	return $elm$core$List$isEmpty(model.T) ? A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$text('Keine Treffer.')
			])) : A2(
		$elm$html$Html$ul,
		_List_Nil,
		A2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$html$Html$Attributes$style, 'border-right', '1px solid #dbdbdb'),
				A2($elm$html$Html$Attributes$style, 'overflow-y', 'auto'),
				$elm$html$Html$Attributes$class('p-3 glossar-col-list')
			]),
		_List_fromArray(
			[
...
var $author$project$View$CocktailSvg$palette = _List_fromArray(
	['#FF6B6B', '#4ECDC4', '#45B7D1', '#FFEAA7', '#DDA0DD', '#96CEB4', '#F0A500', '#BB8FCE', '#82E0AA', '#F1948A']);
var $author$project$View$CocktailSvg$cyclePalette = function (n) {
	var len = $elm$core$List$length($author$project$View$CocktailSvg$palette);
	...
	return A2(
		...
		function (i) {
			return $elm$core$List$head(
				A2(
					$elm$core$List$drop,
					A2($elm$core$Basics$modBy, len, i),
					$author$project$View$CocktailSvg$palette));
		},
		indices);
};
var $author$project$View$CocktailSvg$ingredientColors = function (n) {
	return $author$project$View$CocktailSvg$cyclePalette(n);
};
var $elm$html$Html$span = _VirtualDom_node('span');
var $elm$html$Html$strong = _VirtualDom_node('strong');
var $author$project$View$Glossar$ingredientTag = function (_v0) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('tag is-light is-medium'),
...
var $author$project$View$Glossar$mediaCard = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('media-caption')
						]),
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('media-frame')
						]),
					_List_fromArray(
						[content]))
				]));
...
var $author$project$View$CocktailSvg$glassHeight = 200;
var $author$project$View$CocktailSvg$glassWidth = 120;
var $author$project$View$CocktailSvg$glassX = 20;
var $author$project$View$CocktailSvg$glassY = 20;
var $elm$svg$Svg$Attributes$height = _VirtualDom_attribute('height');
var $elm$svg$Svg$Attributes$id = _VirtualDom_attribute('id');
var $elm$core$List$map3 = _List_map3;
var $author$project$View$CocktailSvg$parseFraction = function (s) {
	var _v0 = A2($elm$core$String$split, '/', s);
	if ((_v0.b && _v0.b.b) && (!_v0.b.b.b)) {
		var num = _v0.a;
		var _v1 = _v0.b;
...
var $author$project$View$CocktailSvg$parseToken = function (rawToken) {
	var token = function () {
		var _v2 = A2($elm$core$String$split, '-', rawToken);
		if (_v2.b && _v2.b.b) {
			var lower = _v2.a;
...
var $author$project$View$CocktailSvg$parseMeasure = function (raw) {
	var words = $elm$core$String$words(raw);
	if (!words.b) {
		return 1.0;
	} else {
		var first = words.a;
		var rest = words.b;
		var _v1 = $author$project$View$CocktailSvg$parseToken(first);
		if (!_v1.$) {
			var n = _v1.a;
			if (rest.b) {
				var next = rest.a;
				var _v3 = $author$project$View$CocktailSvg$parseFraction(next);
				if (!_v3.$) {
					var f = _v3.a;
					return n + f;
				} else {
...
var $author$project$View$CocktailSvg$renderLayers = function (triples) {
	...
	var go = F3(
		function (remaining, yFromBottom, acc) {
			go:
			while (true) {
				if (!remaining.b) {
					return acc;
					...
					var layerRect = A2(
						...
						_List_fromArray(
							[
								...
								$elm$core$String$fromFloat($author$project$View$CocktailSvg$glassX)),
								$elm$svg$Svg$Attributes$y(
								$elm$core$String$fromFloat(yTop)),
								$elm$svg$Svg$Attributes$width(
								$elm$core$String$fromFloat($author$project$View$CocktailSvg$glassWidth)),
								$elm$svg$Svg$Attributes$height(
								$elm$core$String$fromFloat(layerHeight)),
					...
					yFromBottom = $temp$yFromBottom;
					acc = $temp$acc;
					continue go;
				}
			}
		});
	return A3(go, reversed, 0, _List_Nil);
};
...
var $author$project$View$CocktailSvg$view = function (ingredients) {
	var amounts = A2(
		$elm$core$List$map,
		function (i) {
	...
	var total = function (t) {
		return (!t) ? $elm$core$List$length(ingredients) : t;
	}(
	...
	var triples = A4(
		$elm$core$List$map3,
		F3(
			function (ingredient, ratio, colour) {
				return _Utils_Tuple3(ingredient, ratio, colour);
			}),
		ingredients,
		ratios,
		$author$project$View$CocktailSvg$cyclePalette(
			$elm$core$List$length(ingredients)));
	return A2(
		$elm$svg$Svg$svg,
		_List_fromArray(
			[
				$elm$svg$Svg$Attributes$viewBox('0 0 160 240'),
				$elm$svg$Svg$Attributes$style('height: 100%; width: auto; max-width: 100%; display: block;')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$id('glass-clip')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										...
										$elm$core$String$fromFloat($author$project$View$CocktailSvg$glassX)),
										$elm$svg$Svg$Attributes$y(
										$elm$core$String$fromFloat($author$project$View$CocktailSvg$glassY)),
										$elm$svg$Svg$Attributes$width(
										$elm$core$String$fromFloat($author$project$View$CocktailSvg$glassWidth)),
										$elm$svg$Svg$Attributes$height(
										$elm$core$String$fromFloat($author$project$View$CocktailSvg$glassHeight)),
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$clipPath('url(#glass-clip)')
					]),
				$author$project$View$CocktailSvg$renderLayers(triples)),
				A2(
				$elm$svg$Svg$rect,
				_List_fromArray(
					[
						...
						$elm$svg$Svg$Attributes$stroke('#444444'),
...
var $author$project$View$Glossar$cocktailDetail = function (cocktail) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('cocktail-detail')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('title is-4 mb-4')
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('cocktail-media mb-5')
					]),
				_List_fromArray(
					[
						A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('label mb-2')
							]),
						_List_fromArray(
							[
						...
						A2($elm$core$List$map, $author$project$View$Glossar$ingredientTag, zipped))
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('message is-light')
							]),
						_List_fromArray(
							[
								A2(
...
var $author$project$View$Glossar$detailPanel = function (model) {
	var _v0 = model._;
	if (_v0.$ === 1) {
		return A2(
			$elm$html$Html$p,
			...
			_List_fromArray(
				[
					$elm$html$Html$text('← Getränk auswählen')
				]));
	} else {
		var id = _v0.a;
		...
		if (_v1.$ === 1) {
			...
			var cocktail = _v1.a;
			return $author$project$View$Glossar$cocktailDetail(cocktail);
		}
	}
};
...
var $author$project$View$Glossar$modalBody = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$View$Glossar$columnCategories(model),
				$author$project$View$Glossar$columnCocktailList(model),
				$author$project$View$Glossar$columnDetail(model)
			]));
};
var $author$project$Types$GlossarSearchChanged = function (a) {
	return {$: 22, a: a};
};
...
var $author$project$View$Glossar$modalHeader = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('has-background-dark px-5 py-4'),
				A2($elm$html$Html$Attributes$style, 'display', 'flex'),
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('title has-text-white mb-0'),
						A2($elm$html$Html$Attributes$style, 'flex-shrink', '0')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Cocktail-Glossar')
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('field mb-0'),
						A2($elm$html$Html$Attributes$style, 'flex', '1'),
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$placeholder('Cocktail suchen…'),
										$elm$html$Html$Attributes$value(model.Z),
										$elm$html$Html$Events$onInput($author$project$Types$GlossarSearchChanged)
									]),
								_List_Nil),
								A2(
								$elm$html$Html$span,
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('fas fa-magnifying-glass')
											]),
										_List_Nil)
									])),
								$elm$core$String$isEmpty(model.Z) ? $elm$html$Html$text('') : A2(
								$elm$html$Html$span,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('icon is-small is-right'),
										A2($elm$html$Html$Attributes$style, 'pointer-events', 'all'),
										A2($elm$html$Html$Attributes$style, 'cursor', 'pointer'),
										$elm$html$Html$Events$onClick(
										$author$project$Types$GlossarSearchChanged(''))
									]),
								_List_fromArray(
									[
										A2(
...
var $author$project$View$Glossar$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('modal-background'),
						$elm$html$Html$Events$onClick(
						$author$project$Types$NavigateTo(0))
					]),
				_List_Nil),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$style, 'width', '95vw'),
				...
				_List_fromArray(
					[
						$author$project$View$Glossar$modalHeader(model),
						$author$project$View$Glossar$modalBody(model)
					])),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
...
var $author$project$Types$RemoveCocktailFromEvent = function (a) {
	return {$: 28, a: a};
};
var $author$project$Types$SetPortions = F2(
	function (a, b) {
		return {$: 29, a: a, b: b};
	});
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(cocktailName)
						])),
					A2(
					$elm$html$Html$td,
					_List_Nil,
...
var $author$project$View$Home$cocktailListView = F2(
	function (model, event) {
		return $elm$core$List$isEmpty(event.aT) ? A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('has-text-grey-light mt-3')
				]),
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('table is-fullwidth is-striped is-narrow mt-3')
				]),
			_List_fromArray(
				[
					A2(
...
var $author$project$Types$SearchCocktailsForEvent = {$: 25};
var $elm$json$Json$Decode$fail = _Json_fail;
var $author$project$View$Home$enterDecoder = function (msg) {
	return A2(
		$elm$json$Json$Decode$andThen,
		function (key) {
...
var $author$project$Types$AddCocktailToEvent = function (a) {
	return {$: 27, a: a};
};
var $author$project$View$Home$searchResultItem = function (cocktail) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('is-flex-grow-1')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(cocktail.a4)
...
var $author$project$View$Home$searchResultsView = function (results) {
	return $elm$core$List$isEmpty(results) ? $elm$html$Html$text('') : A2(
		...
		A2(
			...
			A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('panel-heading is-size-7')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Suchergebnisse')
					])),
			A2($elm$core$List$map, $author$project$View$Home$searchResultItem, results)));
};
var $author$project$View$Home$cocktailSearchView = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('field has-addons mb-3')
					]),
				_List_fromArray(
					[
						A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Events$on,
										'keydown',
										$author$project$View$Home$enterDecoder($author$project$Types$SearchCocktailsForEvent))
									]),
								_List_Nil)
							])),
						A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Events$onClick($author$project$Types$SearchCocktailsForEvent)
									]),
								_List_fromArray(
									[
				...
				$author$project$View$Home$searchResultsView(model.G)
			]));
};
var $author$project$Types$CloseEventDetail = {$: 19};
var $author$project$Types$SetEventGuestCount = F2(
	function (a, b) {
		return {$: 21, a: a, b: b};
	});
var $author$project$Types$SetEventName = F2(
	function (a, b) {
		return {$: 20, a: a, b: b};
	});
var $author$project$View$Home$detailHeader = function (event) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('is-flex is-justify-content-space-between is-align-items-flex-start')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('is-flex-grow-1 mr-4'),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('is-size-7 has-text-grey mb-1')
									]),
								_List_fromArray(
									[
						...
						_List_fromArray(
							[
								...
								A2($elm$html$Html$Attributes$style, 'flex-shrink', '0'),
								$elm$html$Html$Events$onClick($author$project$Types$CloseEventDetail)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('×')
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('is-flex is-align-items-center mt-3')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('is-size-7 has-text-grey mr-2')
							]),
						_List_fromArray(
							[
...
var $author$project$View$Home$eventDetailView = function (model) {
	...
	if (_v0.$ === 1) {
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('event-empty-state')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('event-empty-icon')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('🍸')
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Kein Event ausgewählt')
						]))
				]));
	} else {
		var eventId = _v0.a;
				...
				_List_fromArray(
					[
						...
						A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('box animate__animated animate__fadeIn')
								]),
							_List_fromArray(
								[
									$author$project$View$Home$detailHeader(event),
									A2($author$project$View$Home$cocktailListView, model, event),
									A2(
									$elm$html$Html$div,
									_List_fromArray(
										[
									...
									_List_fromArray(
										[
											$author$project$View$Home$cocktailSearchView(model)
										]))
								])))
					]));
		}
...
var $author$project$Types$DeleteEvent = function (a) {
	return {$: 16, a: a};
};
var $author$project$Types$DuplicateEvent = function (a) {
	return {$: 17, a: a};
};
var $author$project$Types$OpenEventDetail = function (a) {
	return {$: 18, a: a};
};
var $author$project$Types$OpenShoppingForEvent = function (a) {
	return {$: 32, a: a};
};
var $author$project$View$Home$eventCard = F2(
	function (activeId, event) {
		...
		var cardClass = isActive ? 'card mb-3 has-background-info-light' : 'card mb-3';
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
				...
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('title is-5 mb-1 card-event-name')
										]),
									_List_fromArray(
										[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('subtitle is-6 mb-0 has-text-grey')
								]),
							_List_fromArray(
								[
									$elm$html$Html$text(countLabel + (' · ' + guestLabel))
								]))
						])),
					A2(
					$elm$html$Html$div,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Duplizieren')
								])),
							A2(
							$elm$html$Html$button,
							_List_fromArray(
...
var $author$project$View$Home$eventListView = function (model) {
	return $elm$core$List$isEmpty(model.ai) ? A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('has-text-grey has-text-centered mt-6')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Noch keine Events.')
					])),
				A2(
				$elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('Klicke auf \"+ Neues Event erstellen\" um loszulegen.')
					]))
			])) : A2(
		$elm$html$Html$div,
		_List_Nil,
		A2(
			$elm$core$List$map,
			$author$project$View$Home$eventCard(model.g),
			model.ai));
};
var $author$project$Types$EventFormGuestCountChanged = function (a) {
	return {$: 14, a: a};
};
var $author$project$Types$EventFormNameChanged = function (a) {
	return {$: 13, a: a};
};
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Neues Event erstellen')
									])),
								A2(
								$elm$html$Html$button,
								_List_fromArray(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('button is-primary'),
										$elm$html$Html$Events$onClick($author$project$Types$SaveEvent)
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Erstellen')
									])),
								A2(
								$elm$html$Html$button,
								_List_fromArray(
...
var $author$project$Types$OpenCreateEvent = {$: 12};
var $elm$html$Html$h1 = _VirtualDom_node('h1');
var $author$project$View$Home$pageHeader = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Meine Events')
						]))
				])),
			A2(
			$elm$html$Html$div,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('button is-primary'),
							$elm$html$Html$Events$onClick($author$project$Types$OpenCreateEvent)
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('+ Neues Event erstellen')
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$View$Home$eventModal(model),
						$author$project$View$Home$pageHeader,
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('columns mt-4')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$author$project$View$Home$eventListView(model)
									])),
								A2(
								$elm$html$Html$div,
								_List_fromArray(
								...
								_List_fromArray(
									[
										$author$project$View$Home$eventDetailView(model)
									]))
							]))
					]))
			]));
};
var $author$project$View$Shopping$addAmounts = F2(
	function (a, b) {
			...
			switch (_v0.a.$) {
				case 0:
					if (!_v0.b.$) {
						var x = _v0.a.a;
						var y = _v0.b.a;
						return $author$project$Types$LiquidMl(x + y);
					} else {
						break _v0$2;
					}
				case 1:
					if (_v0.b.$ === 1) {
						var x = _v0.a.a;
						var y = _v0.b.a;
						return $author$project$Types$PieceCount(x + y);
					} else {
						break _v0$2;
					}
				default:
...
var $author$project$View$Shopping$scaleAmount = F2(
	function (portions, amount) {
		var factor = portions;
		switch (amount.$) {
			case 0:
				var ml = amount.a;
				return $author$project$Types$LiquidMl(factor * ml);
			case 1:
				var n = amount.a;
				return $author$project$Types$PieceCount(factor * n);
			default:
				return $author$project$Types$UnknownAmount;
		}
	});
var $elm$core$List$sortWith = _List_sortWith;
var $author$project$View$Shopping$computeTotals = F2(
	function (event, cache) {
		...
		var grouped = A3(
			...
			F2(
				function (_v1, acc) {
					var name = _v1.a;
					var amount = _v1.b;
					var _v2 = A2($elm$core$Dict$get, name, acc);
					if (_v2.$ === 1) {
						return A3($elm$core$Dict$insert, name, amount, acc);
					} else {
						var existing = _v2.a;
						return A3(
							$elm$core$Dict$insert,
							name,
							A2($author$project$View$Shopping$addAmounts, existing, amount),
							acc);
					}
				}),
			$elm$core$Dict$empty,
		...
		return A2(
			...
			$author$project$View$Shopping$compareIngredients,
			A2(
				$elm$core$List$map,
				function (_v0) {
					var name = _v0.a;
...
var $author$project$View$Shopping$currentPackageSize = F2(
	function (name, sizes) {
		return A2(
			$elm$core$Maybe$withDefault,
			700,
			A2($elm$core$Dict$get, name, sizes));
	});
var $author$project$View$Shopping$formatKaufen = F3(
	function (name, amount, packageSizes) {
		switch (amount.$) {
			case 0:
				var ml = amount.a;
				var packageSize = A2($author$project$View$Shopping$currentPackageSize, name, packageSizes);
				var needed = $elm$core$Basics$ceiling(ml / packageSize);
				return (needed === 1) ? '1 Fl.' : ($elm$core$String$fromInt(needed) + ' Fl.');
			case 1:
				var n = amount.a;
				return '× ' + $elm$core$String$fromInt(
					$elm$core$Basics$round(n));
...
var $author$project$Types$SetPackageSize = F2(
	function (a, b) {
		return {$: 30, a: a, b: b};
	});
var $elm$html$Html$option = _VirtualDom_node('option');
var $author$project$View$Shopping$presets = _List_fromArray(
	[
		_Utils_Tuple2(250, '250 ml'),
		_Utils_Tuple2(330, '330 ml (Dose)'),
		_Utils_Tuple2(500, '500 ml'),
		_Utils_Tuple2(700, '700 ml (Standard)'),
		_Utils_Tuple2(1000, '1000 ml (1 L)')
	]);
...
var $author$project$View$Shopping$viewPackageSizeCell = F3(
	function (name, amount, packageSizes) {
		if (!amount.$) {
			var chosen = A2($author$project$View$Shopping$currentPackageSize, name, packageSizes);
			return A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								...
								function (s) {
									...
									if (!_v1.$) {
										var size = _v1.a;
										return A2($author$project$Types$SetPackageSize, name, size);
									} else {
										return A2($author$project$Types$SetPackageSize, name, chosen);
									}
								})
							]),
						A2(
							...
							$author$project$View$Shopping$presets))
					]));
		} else {
			return A2(
				$elm$html$Html$span,
...
var $author$project$View$Shopping$viewRow = F2(
	function (packageSizes, agg) {
		return A2(
			$elm$html$Html$tr,
			_List_Nil,
			_List_fromArray(
...
var $author$project$View$Shopping$viewEvent = F2(
	function (model, event) {
		...
		return $elm$core$List$isEmpty(event.aT) ? A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Cocktaildaten werden noch geladen. Kurz warten und Seite neu laden.')
				])) : A2(
			$elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('table is-fullwidth is-striped is-hoverable')
						]),
					_List_fromArray(
						[
							A2(
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$text('Packungsgröße')
												])),
											A2(
											$elm$html$Html$th,
											_List_Nil,
							...
							A2(
								$elm$core$List$map,
								$author$project$View$Shopping$viewRow(model.aq),
								aggregated))
						]))
				])));
	});
var $author$project$View$Shopping$viewBody = function (model) {
	var _v0 = model.g;
	if (_v0.$ === 1) {
		return A2(
			$elm$html$Html$div,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Öffne ein Event auf der Startseite, um die Einkaufsliste zu berechnen.')
						])),
					A2(
					$elm$html$Html$button,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('button is-primary mt-3'),
							$elm$html$Html$Events$onClick(
							$author$project$Types$NavigateTo(0))
						]),
					_List_fromArray(
		...
		if (_v1.$ === 1) {
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Event nicht gefunden.')
					]));
		} else {
			var event = _v1.a;
			return A2($author$project$View$Shopping$viewEvent, model, event);
		}
	}
};
var $author$project$View$Shopping$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$View$Shopping$viewBody(model)
					]))
			]));
};
var $author$project$Main$routeView = function (model) {
	var _v0 = model.Y;
	switch (_v0) {
		case 0:
			return $author$project$View$Home$view(model);
		case 1:
			return $author$project$View$Shopping$view(model);
		default:
			return A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						...
						$author$project$View$Glossar$view(model)
					]));
	}
};
var $author$project$Types$SaveDialog = 1;
...
var $author$project$Codec$encodeDict = function (dict) {
	return A2(
...
var $author$project$Codec$encodeEventCocktail = function (ec) {
...
var $author$project$Codec$encodeEvent = function (event) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'events',
				A2($elm$json$Json$Encode$list, $author$project$Codec$encodeEvent, model.ai)),
				_Utils_Tuple2(
				'nextEventId',
				$elm$json$Json$Encode$int(model.ao)),
				_Utils_Tuple2(
				'packageSizes',
				$author$project$Codec$encodeDict(model.aq))
			]));
};
var $author$project$Codec$encodeToString = function (model) {
	return A2(
		$elm$json$Json$Encode$encode,
		2,
		$author$project$Codec$encodeState(model));
};
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Projekt speichern')
									])),
								A2(
								$elm$html$Html$button,
								_List_fromArray(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Kopiere den Text und speichere ihn z. B. in einer Textdatei. Beim nächsten Mal kannst du ihn im \"Laden\"-Dialog einfügen.')
									])),
								A2(
								$elm$html$Html$textarea,
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$value(
										$author$project$Codec$encodeToString(model))
									]),
								_List_Nil)
							])),
						A2(
...
var $author$project$Types$OpenDialog = function (a) {
	return {$: 3, a: a};
};
var $author$project$Types$ToggleBurger = {$: 31};
...
var $author$project$View$Topbar$iconButton = F4(
	function (btnClass, msg, faClass, label) {
		return A2(
			$elm$html$Html$button,
			_List_fromArray(
				[
...
var $author$project$View$Topbar$navLink = F3(
	function (model, route, label) {
		var isActive = _Utils_eq(model.Y, route);
		var activeClass = isActive ? 'navbar-item is-active' : 'navbar-item';
		return A2(
			$elm$html$Html$a,
			_List_fromArray(
				[
...
var $author$project$View$Topbar$view = function (model) {
	return A2(
		$elm$html$Html$nav,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('navbar-item has-text-weight-bold')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('CocktailPlaner')
							])),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A3($author$project$View$Topbar$navLink, model, 0, 'Planer'),
								A3($author$project$View$Topbar$navLink, model, 1, 'Einkaufsliste')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										A4(
										$author$project$View$Topbar$iconButton,
										'button is-info is-small mr-2',
										$author$project$Types$NavigateTo(2),
										'fas fa-book-open',
										'Glossar'),
										A4(
										$author$project$View$Topbar$iconButton,
										'button is-light is-small mr-2',
										$author$project$Types$OpenDialog(1),
										'fas fa-floppy-disk',
										'Speichern'),
										A4(
										$author$project$View$Topbar$iconButton,
										'button is-light is-small',
										$author$project$Types$OpenDialog(2),
										'fas fa-folder-open',
										'Laden')
									]))
							]))
	...
	return {
		aQ: _List_fromArray(
			[
				...
				$author$project$Main$saveDialog(model),
				$author$project$Main$loadDialog(model)
			]),
		bh: 'CocktailPlaner'
	};
};
